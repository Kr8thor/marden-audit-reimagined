      ...
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center space-x-8">
          <nav className="flex items-center space-x-6">
            ...
            <a href="/test-crawl" className="text-sm font-medium text-foreground/80 hover:text-foreground transition-colors">Test Crawl</a>
            <a href="/mock-debugger" className="text-sm font-medium text-foreground/80 hover:text-foreground transition-colors">Debug</a>
          </nav>
          <AnimatedButton 
            variant="primary" 
            glowColor="purple" 
